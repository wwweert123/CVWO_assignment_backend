...
class ForumThreadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forum_thread" do
    assert_difference("ForumThread.count") do
      post forum_threads_url, params: { forum_thread: { description: @forum_thread.description, title: @forum_thread.title, upvotes: @forum_thread.upvotes } }, as: :json
    end
  ...
  test "should update forum_thread" do
    patch forum_thread_url(@forum_thread), params: { forum_thread: { description: @forum_thread.description, title: @forum_thread.title, upvotes: @forum_thread.upvotes } }, as: :json
    assert_response :success
  end
